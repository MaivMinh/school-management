package com.foolish.schoolmanagement.aspects;
...
public class LoggerAspect {
  @Around("execution(* com.foolish.schoolmanagement..*.*(..))")
  ...
  @AfterThrowing(value = "execution(* com.foolish.schoolmanagement.*.*(..))", throwing = "ex")
